...
def print_and_log(
    ...
    ori_green_token_ratios=None,
    wm_green_token_ratios=None,
    para_green_token_ratios=None,
    senti_green_token_ratios=None,
    hate_green_token_ratios=None,
    ppl=None,
    ...
    wandb.log({
        ...
        "train/ori_green_ratio": torch.mean(ori_green_token_ratios).item(),
        "train/wm_green_ratio": torch.mean(wm_green_token_ratios).item(),
        "train/para_green_ratio": torch.mean(para_green_token_ratios).item(),
        "train/senti_green_ratio": torch.mean(senti_green_token_ratios).item(),
        "train/hate_green_ratio": torch.mean(hate_green_token_ratios).item(),
        #==========debug======== #
