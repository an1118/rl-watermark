...
from watermark_attack import paraphrase_attack, spoofing_attack, latter_spoofing_attack, hate_attack, base_attack
...
def main(args):
    ...
    if os.path.exists(f'{args.output_file}'):
        ...
        df = pd.DataFrame(columns=['text_id', 'original_text', 'adaptive_watermarked_text', \
                        'human_score', 'adaptive_watermarked_text_score'])
