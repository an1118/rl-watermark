...
class Args:
    ...
    embed_map_model_name: str = "/blue/buyuheng/li_an.ucsb/projects/contrastive-watermark/contrastive_train/result/map_to_vocab_size/64batch_15epochs/llama8gpt8-sent1-latter_sent1-hate1/loss_margin0.9/checkpoint-435"
...
class Actor(nn.Module):
    ...
    def compute_rewards(self, data, watermarked_texts):
        ...
        # overall reward
        rewards = []
        for r, q in zip(relevance_scores_filled, text_quality_scores_filled):
            reward = r + q
...
if __name__ == "__main__":
    ...
    for iteration in tqdm(range(1, args.num_iterations + 1), desc="Training iterations"):
        ...
        for i in range(0, len(train_set), args.batch_size):
            ...
            ## compute rewards
            all_rewards = []  # [B, G]
            all_rewards_relevance, all_rewards_text_quality = [], []  # [B*G]
