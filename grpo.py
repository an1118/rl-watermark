...
if __name__ == "__main__":
    ...
    run_name = f"batch{args.batch_size}-nmini{args.num_minibatches}-G{args.G}-detect_hate"
    if args.binary:
        run_name += "-binary"

    # make checkpoint dir and init best reward
    args.checkpoint_dir = rf"/blue/buyuheng/li_an.ucsb/projects/rl-watermark/ckpts/batch{args.batch_size}-nmini{args.num_minibatches}-G{args.G}-detect_hate"
    if args.binary:
